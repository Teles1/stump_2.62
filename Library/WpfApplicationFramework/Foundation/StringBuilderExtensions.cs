...
namespace System.Waf.Foundation
{
    ...
    /// </summary>
    [Obsolete("This helper class is obsolete. Please use the string.Join(Environment.NewLine, stringList) method instead of the AppendInNewLine method.")]
    public static class StringBuilderExtensions
    {
        ...
        [Obsolete("Please use the string.Join(Environment.NewLine, stringList) method instead of this one.")]

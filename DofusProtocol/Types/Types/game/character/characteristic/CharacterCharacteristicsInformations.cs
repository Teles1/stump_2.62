...
// From 'CharacterCharacteristicsInformations.xml' the '04/04/2012 14:27:36'
using System;
using Stump.Core.IO;
...
namespace Stump.DofusProtocol.Types
{
	public class CharacterCharacteristicsInformations
	{
		...
		public virtual void Deserialize(IDataReader reader)
		{
			...
			{
				(spellModifications as CharacterSpellModification[])[i] = new Types.CharacterSpellModification();
